...
def mixture_descriptors2(data21, data22,fraction_sbma,fraction_pdms):
    ...
    # Multiply corresponding rows in test_data21 and test_data22 for all columns
    df_mixture_left2 = test_data21.applymap(lambda x: x * fraction_sbma)
    df_mixture_right2 = test_data22.applymap(lambda x: x * fraction_pdms)
